...
class MockLegacyModule(BaseModule):
    ...
    def __init__(self, config=None, base_orchestrator=None, llm_client_factory=None):
        ...
        self.credential_manager = Mock() if base_orchestrator is None else getattr(base_orchestrator, 'credential_manager', None)
...
class TestAuthHelperIntegration:
    ...
    @pytest.mark.asyncio
    async def test_auth_helper_fallback_chain(self, mock_credential_manager, mock_llm_client_factory):
