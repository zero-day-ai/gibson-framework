...
class TestChangeAnalyzer:
    ...
    def test_analyze_enum_value_removal(self):
        ...
        changeset = ChangeSet(
            enum_changes={
                "status": EnumChange(enum_name="status", removed_values=["deprecated_status"])
            },
            model_hash_before="hash1",
            model_hash_after="hash2",
        )
    ...
    def test_risk_level_calculation(self):
        ...
        changeset_low = ChangeSet(
            added_fields={
                "optional_field": FieldInfo(name="optional_field", type="string", nullable=True)
            },
            model_hash_before="hash1",
            model_hash_after="hash2",
        )
        ...
        changeset_critical = ChangeSet(
            removed_fields=["critical_field"], model_hash_before="hash1", model_hash_after="hash2"
        )
    ...
    def test_suggested_actions(self):
        ...
        # Data loss scenario
        changeset = ChangeSet(
            removed_fields=["important_data"], model_hash_before="hash1", model_hash_after="hash2"
        )
