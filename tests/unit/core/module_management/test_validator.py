...
class TestModuleValidator:
    ...
    async def test_validate_structure_valid_module(
        self, temp_module_file, valid_module_content, mock_security_validator
    ):
    ...
    async def test_validate_structure_invalid_module(
        self, temp_module_file, invalid_module_content, mock_security_validator
    ):
    ...
    async def test_validate_code_dangerous_imports(
        self, temp_module_file, malicious_module_content
    ):
    ...
    @pytest.mark.asyncio
    async def test_validate_code_clean_module(self, temp_module_file, valid_module_content):
    ...
    async def test_validate_security_delegates_to_security_validator(
        self, temp_module_file, mock_security_validator
    ):
    ...
    async def test_validate_dependencies_dangerous(self):
        ...
        dangerous_deps = [
            issue for issue in result.security_issues if issue.issue_type == "dangerous_dependency"
        ]
...
"""
        ...
        complexity_warnings = [
            warning for warning in result.warnings if "complexity" in warning.lower()
        ]
