...
class TestModuleRegistry:
    ...
    @pytest.mark.asyncio
    async def test_register_module_existing_no_overwrite(self, mock_cache, mock_session, sample_module_definition, sample_module_record):
    ...
    @pytest.mark.asyncio
    async def test_register_module_existing_with_overwrite(self, mock_cache, mock_session, sample_module_definition, sample_module_record):
    ...
    @pytest.mark.asyncio
    async def test_register_module_database_error(self, mock_cache, mock_session, sample_module_definition):
