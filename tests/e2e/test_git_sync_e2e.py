    ...
    async def test_public_repo_sync_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            async with manager:
                ...
                repo_path = workspace / "payloads" / "repositories" / "github.com" / "octocat" / "Hello-World"
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            async with manager:
                ...
                for repo_url in repos:
                    ...
                    repo_path = workspace / "payloads" / "repositories" / git_url.host / git_url.owner / git_url.repo
                    assert repo_path.exists()
...
class TestCLIIntegration:
    ...
    def test_cli_sync_command_success(self):
        ...
        with patch('gibson.cli.commands.payloads.PayloadManager') as MockManager:
            ...
            result = runner.invoke(
                payloads.app,
                ["sync", "https://github.com/test/repo.git"]
            )
    ...
    def test_cli_sync_with_branch(self):
        ...
        with patch('gibson.cli.commands.payloads.PayloadManager') as MockManager:
            ...
            result = runner.invoke(
                payloads.app,
                ["sync", "https://github.com/test/repo.git", "--branch", "develop"]
            )
    ...
    def test_cli_sync_error_handling(self):
        ...
        with patch('gibson.cli.commands.payloads.PayloadManager') as MockManager:
            ...
            result = runner.invoke(
                payloads.app,
                ["sync", "https://github.com/private/repo.git"]
            )
    ...
    async def test_gibson_prompt_library_sync(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            async with manager:
                ...
                repo_path = workspace / "payloads" / "repositories" / "github.com" / "zero-day-ai" / "gibson-prompt-library"
                assert repo_path.exists()
...
def test_complete_user_journey():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch('gibson.cli.commands.payloads.PayloadManager') as MockManager:
            ...
            result = runner.invoke(
                payloads.app,
                ["sync", "https://github.com/zero-day-ai/gibson-prompt-library.git"]
            )
