...
class RollbackManager:
    ...
    def __init__(
        self, version_registry: Optional[VersionRegistry] = None, backup_dir: Optional[Path] = None
    ):
        """
    ...
    def clean_old_backups(self, keep_count: int = 10, keep_days: int = 30) -> int:
        """
    ...
    def _get_rollback_path(self, from_version: str, to_version: str) -> List[str]:
        ...
        path = self.comparator.get_range(all_versions, start=to_version, end=from_version)
    ...
    def _validate_rollback(self, rollback_path: List[str]) -> List[str]:
        ...
        for version in rollback_path:
            ...
            if (
                rollback_point.migration_script
                and not rollback_point.migration_script.downgrade_sql
            ):
