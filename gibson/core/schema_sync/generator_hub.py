...
class SchemaGeneratorHub:
    ...
    def validate_schema_consistency(self, bundle: SchemaBundle) -> Dict[str, Any]:
        ...
        if not bundle.typescript_types:
            warnings.append({"type": "missing", "format": "typescript", "message": "TypeScript types missing"})
        
        if not bundle.sqlalchemy_model:
            warnings.append({"type": "missing", "format": "sqlalchemy", "message": "SQLAlchemy model missing"})
    ...
    def _generate_typescript_types(self, model: Type[BaseModel], json_schema: Dict[str, Any]) -> str:
        """
    ...
    def _generate_sqlalchemy_model(self, model: Type[BaseModel], json_schema: Dict[str, Any]) -> str:
        """
