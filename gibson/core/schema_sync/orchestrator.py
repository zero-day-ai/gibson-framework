...
class SchemaOrchestrator:
    ...
    def sync_schemas(
        self,
        model: Type[BaseModel] = PayloadModel,
        ...
        try:
            ...
            if analysis.breaking_changes:
                data_migrations = self.data_planner.plan_data_migration(
    ...
    def _migration_to_dict(self, migration: Any) -> Dict[str, Any]:
        ...
        return {
            ...
            "estimated_duration": str(migration.estimated_duration) if migration.estimated_duration else None,
