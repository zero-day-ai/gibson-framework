...
class Alert(GibsonBaseModel):
    ...
    def format_message(self) -> str:
        ...
        if self.context:
            lines.extend(["", "Context:", json.dumps(self.context, indent=2, default=str)])
...
class SchemaMonitor:
    ...
    def monitor_breaking_changes(self, changes: List[Dict[str, Any]]):
        """
    ...
    def monitor_migration_failure(self, version: str, error: str, rollback_attempted: bool = False):
        """
        ...
        self.alert(
            ...
            context={"version": version, "error": error, "rollback_attempted": rollback_attempted},
        )

    def monitor_data_loss_risk(self, fields: List[str], affected_rows: int):
        """
        ...
        if affected_rows > 0:
            self.alert(
                ...
                context={"fields": fields, "affected_rows": affected_rows},
            )
    ...
    def export_metrics(self, output_path: Path):
        ...
        data = {
            ...
            "summary": {"metrics": self.get_metrics_summary(), "alerts": self.get_alert_summary()},
