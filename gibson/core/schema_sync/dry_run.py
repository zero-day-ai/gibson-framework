...
class DryRunExecutor:
    ...
    def execute(
        ...
        result = DryRunResult(
            success=False,
            changes_detected=self._summarize_changes(changeset)
        )
        ...
        try:
            ...
            with self._create_test_database() as test_db:
                ...
                if migration.downgrade_sql:
                    ...
                    result.rollback_success = self._test_rollback(
                        test_db, 
                        migration,
                        test_data
                    )
                ...
                if not integrity_check["valid"]:
                    result.errors.append(f"Data integrity check failed: {integrity_check['message']}")
