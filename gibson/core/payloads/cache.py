...
class PayloadCache:
    ...
    def __init__(
        ...
        logger.debug(f"Initialized PayloadCache with max_size={max_size}, ttl={default_ttl_seconds}s")
    ...
    async def get_hot_payloads(self, limit: int = 10) -> List[Tuple[str, int]]:
        ...
        async with self._lock:
            payload_access = [
                ...
                for key, entry in self._payload_cache.items()
            ]
    ...
    async def optimize_cache(self) -> Dict[str, Any]:
        ...
        async with self._lock:
            ...
            logger.info(f"Cache optimization removed {optimization_results['removed_count']} stale entries")
