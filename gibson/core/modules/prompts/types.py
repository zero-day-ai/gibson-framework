...
class AttackResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "leaked_content": self.leaked_content[:200] + "..." if self.leaked_content and len(self.leaked_content) > 200 else self.leaked_content,
...
class LeakageDetection:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "similarity_scores": self.similarity_scores.to_dict() if self.similarity_scores else None,
            "behavioral_indicators": self.behavioral_indicators.to_dict() if self.behavioral_indicators else None,
...
def merge_detection_results(results: List[LeakageDetection]) -> LeakageDetection:
    ...
    return LeakageDetection(
        ...
        metadata={"merged_from": len(results), "individual_confidences": [r.confidence for r in results]}
    )
