...
class PromptInjectionModule(PromptDomain):
    ...
    async def run(self, target: Target, config: Optional[Dict[str, Any]] = None) -> List[Finding]:
        ...
        injection_types = config.get("injection_types", [t.value for t in InjectionType])
                    ...
                    if await self._analyze_injection_success(result, injection_enum):
                        ...
                        finding = Finding(
                            ...
                            evidence={
                                ...
                                "prompt": injection_prompt[:200] + "..."
                                if len(injection_prompt) > 200
    ...
    async def _analyze_injection_success(
        self, response: str, injection_type: InjectionType
    ) -> bool:
    ...
    def get_config_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "injection_types": {
                    "type": "array",
                    "items": {"type": "string", "enum": [t.value for t in InjectionType]},
                    "description": "Types of injection attacks to perform",
                },
                "evasion_techniques": {
                    "type": "array",
                    "items": {"type": "string", "enum": [t.value for t in EvasionTechnique]},
