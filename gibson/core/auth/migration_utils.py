...
class MigrationManager:
    ...
    def __init__(
        self, config: Optional[AuthenticationConfig] = None, migration_dir: Optional[Path] = None
    ):
...
class BackupManager:
    ...
    def __init__(
        self, config: Optional[AuthenticationConfig] = None, backup_dir: Optional[Path] = None
    ):
    ...
    def restore_backup(
        self, backup_file: Path, restore_credentials: bool = True, restore_migrations: bool = True
    ) -> bool:
    ...
    def _export_schema(self) -> Dict[str, Any]:
        ...
        return {"tables": ["encrypted_credentials", "auth_migrations"], "version": "1.0"}
