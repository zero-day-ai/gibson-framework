...
class CredentialEncryption:
    ...
    def decrypt_credential(self, encrypted_data: bytes, target_id: str) -> str:
        ...
        try:
            ...
            tag = encrypted_data[
                self.SALT_SIZE + self.IV_SIZE : self.SALT_SIZE + self.IV_SIZE + self.TAG_SIZE
            ]
    ...
    def is_encryption_available(cls) -> bool:
        ...
        try:
            ...
            cipher = Cipher(algorithms.AES(test_key), modes.GCM(test_iv))
