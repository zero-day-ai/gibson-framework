...
class LegacyAuthAdapter:
    ...
    async def get_api_key(
        self, provider: str, target_id: Optional[Union[str, UUID]] = None
    ) -> Optional[str]:
        """
        ...
        self.deprecated_auth_warning(
            "get_api_key", "module.get_llm_client() or llm_client_factory.get_client()"
        )
        ...
        if self.llm_client_factory and LLM_AVAILABLE:
            try:
                ...
                if hasattr(client, "provider_config") and hasattr(
                    client.provider_config, "api_key"
                ):
    ...
    async def get_provider_client(self, provider: str) -> Optional["AsyncLLMClient"]:
        ...
        """
        self.deprecated_auth_warning("get_provider_client", "module.get_llm_client(provider)")
...
class ModuleAuthHelper:
    ...
    async def get_authenticated_client(
        self, provider: Optional[str] = None, target_id: Optional[Union[str, UUID]] = None
