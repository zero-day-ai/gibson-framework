...
def template(
    output_file: Optional[Path] = typer.Option(
        None,
        "--output", "-o",
        help="Output file for template (stdout if not specified)"
    ),
    full: bool = typer.Option(
        False,
        "--full", "-f",
        help="Include all optional fields"
    ),
    schema_version: str = typer.Option(
        "latest",
        "--version", "-v",
...
def info(
    field: Optional[str] = typer.Argument(
        None,
        help="Field name to get info about"
    ),
    schema_version: str = typer.Option(
        "latest",
        "--version", "-v",
...
def sync(
    ...
    force: bool = typer.Option(
        False,
        "--force",
        help="Apply changes even with breaking changes"
    ),
    version: Optional[str] = typer.Option(
        None,
        "--version", "-v",
        help="Specify version for migration"
    ),
    verbose: bool = typer.Option(
        False,
        "--verbose",
...
def check(
    ...
    ci: bool = typer.Option(
        False,
        "--ci",
        help="CI mode - exit with error if changes detected"
    ),
):
